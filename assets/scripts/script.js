...
async function getApiGithub() {
    try {
        ...
        const dadosPerfil = await fetch(`https://api.github.com/users/EliseuZeu`);
        ...
        let conteudo = `
            ...
            <article id="about_texto">
                <h2>Sobre mim</h2>
                <p>Sou Desenvolvedor Fullstack com foco em JavaScript, formado em Análise e Desenvolvimento de Sistemas na Universidade São Francisco.
                Tenho experiência prática em desenvolvimento web, orientação a objetos e design gráfico.
                Recentemente, participei de projetos como o <strong>CloudSystem</strong>,
                uma aplicação CRUD com interface amigável.</p>
